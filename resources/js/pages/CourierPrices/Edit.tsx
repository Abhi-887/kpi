...
export default function EditCourierPrice({ courierPrice }: Props) {
  ...
  const { data, setData, patch, processing, errors } = useForm({
    name: courierPrice.name,
    description: courierPrice.description || '',
    carrier_name: courierPrice.carrier_name,
    service_type: courierPrice.service_type,
    base_price: String(courierPrice.base_price),
    per_kg_price: String(courierPrice.per_kg_price),
    surcharge: String(courierPrice.surcharge),
    transit_days: String(courierPrice.transit_days),
    coverage_area: courierPrice.coverage_area,
    is_active: courierPrice.is_active,
  })

  const submit = (e: React.FormEvent) => {
    e.preventDefault()
    patch(`/courier-prices/${courierPrice.id}`)
  }
