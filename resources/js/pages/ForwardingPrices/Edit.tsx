...
export default function EditForwardingPrice({ forwardingPrice }: Props) {
  ...
  const { data, setData, patch, processing, errors } = useForm({
    name: forwardingPrice.name,
    description: forwardingPrice.description || '',
    origin_country: forwardingPrice.origin_country,
    destination_country: forwardingPrice.destination_country,
    service_type: forwardingPrice.service_type,
    base_price: String(forwardingPrice.base_price),
    per_kg_price: String(forwardingPrice.per_kg_price),
    per_cbm_price: String(forwardingPrice.per_cbm_price),
    handling_fee: String(forwardingPrice.handling_fee),
    transit_days: String(forwardingPrice.transit_days),
    is_active: forwardingPrice.is_active,
  })

  const submit = (e: React.FormEvent) => {
    e.preventDefault()
    patch(`/forwarding-prices/${forwardingPrice.id}`)
  }
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Edit Forwarding Price" />
